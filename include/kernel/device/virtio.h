...
struct virtq_avail {
	...
	uint16_t ring[VIRTIO_DESCIPTOR_NUM]; // descriptor numbers of chain heads
	uint16_t unused;
};
...
struct virtq_used {
	...
	struct virtq_used_elem ring[VIRTIO_DESCIPTOR_NUM];
	uint16_t unused;
};
